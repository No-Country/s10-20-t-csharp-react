                            ...
                            <form className='w-full' action="#">
                                <div className="flex flex-col gap-6 sm:gap-4 mt-9 sm:mx-auto sm:w-full sm:max-w-sm">
                                    ...
                                    <div className='justify-center text-center mt-6 bg-blue-950 border rounded-xl'>
                                        <button className=' bg-blue-950 border-none text-center  text-white'>Iniciar Sesion</button>
                                    </div>

                                    <div className=' flex justify-center mt-4 font-bold bg-white border rounded-xl'>
                                        <GoogleIcon />
                                        <button className='border-none text-center '>Iniciar Sesion con Google</button>
                                    </div>
                                
                                    <div className='justify-center text-center font-bold bg-white border rounded-xl'>
