...
const Modal = () => {
    ...
    return (
        <div className={`w-full flex flex-col gap-4 h-full items-center justify-center absolute top-0 bg-slate-50`}>
            <form action="#" className="flex flex-col gap-2 bg-[#D9D9D9] items-center w-fit p-10 rounded-[20px] relative" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="w-full">
                    ...
                    <input type="text" name="#" id="#" className="p-2 w-full rounded-xl border-black border-[1.8px]" {...register("title", { required: true })} />
                </div>
                <div className="w-full relative">
                    {/*<label htmlFor="#" className="absolute mt-2 pl-2 font-medium">Categoría</label>*/}
                    <input type="text" name="#" id="#" className="p-2 w-full rounded-xl border-black border-[1.8px] placeholder:text-black" placeholder="Categoría" {...register("category_ID", { required: true })} />
                </div>
                <div className="w-full relative">
                    {/*<label htmlFor="#" className="absolute mt-2 pl-2 font-extralight">Descripción</label>*/}
                    <textarea rows={10} cols={55} className="rounded-xl border-black border-[1.5px] p-2 placeholder:text-black" placeholder="Descripción" {...register("text", { required: true })} />
                </div>
                <div className="w-full">
                    ...
                    <input type="text" name="#" id="#" className="p-2 w-full rounded-xl border-black border-[1.8px]" {...register("district_ID", { required: true })} />
                </div>
